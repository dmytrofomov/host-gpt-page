...
- Папір `#f6f0e6`, картка `#fffaf2`, чорнило `#1c1a16`, приглушене `#6b6458`, ліс `#163226`, акцент `#1f7a45`, волосся `#e4d9c8`
- Шрифти: Fraunces (заголовки) + Manrope (тіло), один Google Fonts stylesheet
- Hero: CSS-чат у стилі Telegram, не фото і не гігантське лого
- `color-scheme: light`, `theme-color` = папір
